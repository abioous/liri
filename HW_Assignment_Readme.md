...
I have build node js application that query twitter, spotify, omdbapi

## Live Link
 - https://github.com/abioous/liri/blob/master/liri.js
...
- Java Script
- node 
- node modules:(fs, request, twitter, spotify)